        ...
        {visiblePrimarySections.map((section: NavigationSection) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "group flex items-center gap-3 rounded-2xl px-2.5 py-2 transition-[background-color,color,box-shadow,transform] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--brand)]",
                sectionActive
